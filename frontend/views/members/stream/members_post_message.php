			...
			echo "
				<div class=\"sub_comment\" id=\"comment_".$row['members_stream_id']."\">
					...
					<div class=\"comment_text\">
						<div id=\"member_link\"><a href=\""._ROOT_PATH_URL_."/profile.php?user_id=".$from_user_id."\">".members_get_info("nombre",$from_user_id) . " " . members_get_info("apellido",$from_user_id)."</a>
	...
	<div id=\"comments\"><!--comments-->
		<div class=\"comment\" id=\"comment_". $row['members_stream_id']."\"><!--comment-->
			...
			<div class=\"comment_text\"><!--comment_text-->
				<div id=\"member_link\">
					<a href=\""._ROOT_PATH_URL_."/profile.php?user_id=".$from_user_id."\">".members_get_info("nombre",$from_user_id) . " " . members_get_info("apellido",$from_user_id)."</a>
