...
<script>
	...
	function karma_update(id){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $GEN_URL_SERVIDOR?>/include/members/stream/members_post_message.php",
	...
	function show_more_comments(param){
		$("#show_more_comments").html("<img src='<?php echo $GEN_URL_SERVIDOR?>/images/ajax-loader.gif'>")
		...
		$.ajax({	
			type: "POST",
			url: "<?php echo $GEN_URL_SERVIDOR?>/include/members/stream/members_stream_get_messages.php",
			contentType: "application/x-www-form-urlencoded;charset=ISO-8859-15",
			data: dataString,
			dataType: "html",
			success: function(msg) {
	...
	function get_sub_comments(id){
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $GEN_URL_SERVIDOR?>/include/members/stream/members_stream_get_sub_comments.php",
			contentType: "application/x-www-form-urlencoded;charset=ISO-8859-15",
			data: dataString,
			dataType: "html",
			success: function(msg) {
